...
of truth. The enforcement register, the PR template and the Codex hooks are generated
from it; CI fails on any drift between the registry and its outputs.
...
| Read | For |
|---|---|
| `governance/rules.ts` | **The rules.** All of them. |
